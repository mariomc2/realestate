...
class EngagementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engagement" do
    assert_difference('Engagement.count') do
      post engagements_url, params: { engagement: { building_id: @engagement.building_id, role: @engagement.role, user_id: @engagement.user_id } }
    end
  ...
  test "should update engagement" do
    patch engagement_url(@engagement), params: { engagement: { building_id: @engagement.building_id, role: @engagement.role, user_id: @engagement.user_id } }
