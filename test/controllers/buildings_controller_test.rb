...
class BuildingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create building" do
    assert_difference('Building.count') do
      post buildings_url, params: { building: { identifier: @building.identifier, name: @building.name, type: @building.type } }
    end
  ...
  test "should update building" do
    patch building_url(@building), params: { building: { identifier: @building.identifier, name: @building.name, type: @building.type } }
